...
export default function Footer() {
  return (
    <footer className="bg-zinc-950 flex flex-col justify-center items-center md:flex-row  md:justify-evenly h-full p-4 ">
      <p className="text-gray-50 text-center pt-8">©BizarroCodes</p>
      <ul className="flex gap-4 justify-evenly mt-2  w-fit">
        <li>
